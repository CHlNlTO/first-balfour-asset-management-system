...
class CEMREmployeePolicy
{
     ...
     */
    public function view(User $user, CEMREmployee $cEMREmployee): bool
    {
     ...
     */
    public function update(User $user, CEMREmployee $cEMREmployee): bool
    {
     ...
     */
    public function delete(User $user, CEMREmployee $cEMREmployee): bool
    {
     ...
     */
    public function forceDelete(User $user, CEMREmployee $cEMREmployee): bool
    {
     ...
     */
    public function restore(User $user, CEMREmployee $cEMREmployee): bool
    {
     ...
     */
    public function replicate(User $user, CEMREmployee $cEMREmployee): bool
    {
